...
class Bus(models.Model):
	...
	bus_number_tickets_initial = models.IntegerField(null=True)
	bus_started_from_depot_flag = models.IntegerField(null=True)
	bus_started_from_depot_time = models.DateTimeField(null=True, blank=True)  # UTC time
	bus_first_aid_kit_available_flag = models.IntegerField(null=True)
	...
	everyone_dropped_off_flag = models.IntegerField(null=True)
	everyone_dropped_off_time = models.DateTimeField(null=True, blank=True)  # UTC time
	feedback_form_taken_from_ngo_flag = models.IntegerField(null=True)
	...
	bus_furthest_screen = models.IntegerField(null=True)
